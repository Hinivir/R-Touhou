...
GameEngine::Entity spawnMovableEntity(GameEngine::Registry &registry)
{
    ...
    registry.addComponent<GameEngine::Sprite>(entity,
GameEngine::Sprite{"../games/resources/R-Touhou/graphics/Player.png",sf::Sprite(),sf::Texture()});
...
GameEngine::Entity spawnEnemyEntity(GameEngine::Registry &registry)
{
    ...
    registry.addComponent<GameEngine::Sprite>(entity,
GameEngine::Sprite{"../games/resources/R-Touhou/graphics/Enemy.png",sf::Sprite(),sf::Texture()});
    registry.addComponent<GameEngine::Hitbox>(entity, GameEngine::Hitbox{});
...
GameEngine::Sprite{"../games/resources/R-Touhou/graphics/BackgroundStar.jpg",sf::Sprite(),sf::Texture()});
    registry.addComponent<GameEngine::ZIndex>(backgroundStar,
GameEngine::ZIndex{GAME_ENGINE_Z_INDEX_VALUE_LOWEST_VALUE});
...
GameEngine::Entity createGroundDown(GameEngine::Registry &registry)
{
    ...
    registry.addComponent<GameEngine::Sprite>(groundDown,
GameEngine::Sprite{"../games/resources/R-Touhou/graphics/Ground.png",sf::Sprite(),sf::Texture()});
    registry.addComponent<GameEngine::ZIndex>(groundDown, GameEngine::ZIndex{GAME_ENGINE_Z_INDEX_VALUE_LOWEST_VALUE +
1}); registry.addComponent<GameEngine::Controllable>(groundDown, GameEngine::Controllable{false});
...
GameEngine::Entity createGroundUp(GameEngine::Registry &registry)
{
    ...
    registry.addComponent<GameEngine::Sprite>(groundUp,
GameEngine::Sprite{"../games/resources/R-Touhou/graphics/Ground.png",sf::Sprite(),sf::Texture()});
...
GameEngine::Entity createScore(GameEngine::Registry &registry)
{
    ...
    registry.addComponent<GameEngine::Text>(score, GameEngine::Text{sf::Text(), sf::Font(), scoreText,
"../games/resources/R-Touhou/font/arial.ttf", 40});
...
GameEngine::Entity createGameOver(GameEngine::Registry &registry)
{
    ...
    registry.addComponent<GameEngine::Position>(gameOver, GameEngine::Position{WINDOW_WIDTH / 2 - 220, WINDOW_HEIGHT / 2
- 120}); registry.addComponent<GameEngine::ZIndex>(gameOver,
GameEngine::ZIndex{GAME_ENGINE_Z_INDEX_VALUE_DEFAULT_VALUE}); registry.addComponent<GameEngine::Color>(gameOver,
GameEngine::Color{255, 255, 255, 255}); std::string gameOverText = "Game Over";
    registry.addComponent<GameEngine::Text>(gameOver, GameEngine::Text{sf::Text(), sf::Font(), gameOverText,
"../games/resources/R-Touhou/font/arial.ttf", 80});
...
GameEngine::Entity createYouWin(GameEngine::Registry &registry)
{
    ...
    registry.addComponent<GameEngine::Position>(youWin, GameEngine::Position{WINDOW_WIDTH / 2 - 220, WINDOW_HEIGHT / 2 -
120}); registry.addComponent<GameEngine::ZIndex>(youWin, GameEngine::ZIndex{GAME_ENGINE_Z_INDEX_VALUE_DEFAULT_VALUE});
    registry.addComponent<GameEngine::Color>(youWin, GameEngine::Color{255, 255, 255, 255});
    std::string youWinText = "You Win !";
    registry.addComponent<GameEngine::Text>(youWin, GameEngine::Text{sf::Text(), sf::Font(), youWinText,
"../games/resources/R-Touhou/font/arial.ttf", 80});
