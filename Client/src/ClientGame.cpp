...
GameEngine::Entity Game::ClientGame::spawnMovableEntity(GameEngine::Registry &registry)
{
...
GameEngine::Entity Game::ClientGame::spawnEnemyEntity(GameEngine::Registry &registry)
{
    GameEngine::Entity entity = spawnBaseEntity(registry);
...
GameEngine::Entity Game::ClientGame::createBackgroundStar(GameEngine::Registry &registry)
{
...
GameEngine::Entity Game::ClientGame::createGroundDown(GameEngine::Registry &registry)
{
...
GameEngine::Entity Game::ClientGame::createGroundUp(GameEngine::Registry &registry)
{
...
GameEngine::Entity Game::ClientGame::createScore(GameEngine::Registry &registry)
{
...
GameEngine::Entity Game::ClientGame::createGameOver(GameEngine::Registry &registry)
{
...
GameEngine::Entity Game::ClientGame::createYouWin(GameEngine::Registry &registry)
{
