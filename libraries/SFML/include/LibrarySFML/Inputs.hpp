...
static const LibrarySFML::KeyboardToInputList KEYBOARD_TO_INPUT_LIST[] = {
    // Text
    {sf::Keyboard::Comma,       LType::InputList::KEY_COMMA},
    {sf::Keyboard::Period,      LType::InputList::KEY_PERIOD},
    {sf::Keyboard::SemiColon,   LType::InputList::KEY_SEMICOLON},
    {sf::Keyboard::Space,       LType::InputList::KEY_SPACE},
    // Numbers
    ...
    // Special
    {sf::Keyboard::Escape,      LType::InputList::KEY_ESC},
    {sf::Keyboard::Return,      LType::InputList::KEY_RETURN},
    // Actions
